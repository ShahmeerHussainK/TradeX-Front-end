...
import { adminMatchesTableHeader } from '@/lib/data';
      ...
      <Table className="cursor-pointer">
        <TableHeader className="h-16">
          <TableRow className="text-nowrap bg-indigo-600 hover:bg-indigo-500">
            {adminMatchesTableHeader?.map((header, index) => (
              <TableHead
                key={index}
        ...
        <TableBody>
          {currentData?.map((row, index) => (
            ...
            >
              ...
              <TableCell>
                {DateTime.fromISO(row.bet_start_time).toLocaleString(
                  DateTime.DATETIME_MED
                )}
              </TableCell>
              <TableCell className="font-bold text-gray-600">
                {DateTime.fromISO(row.bet_end_time).toLocaleString(
                  DateTime.DATETIME_MED
                )}
              </TableCell>
            </TableRow>
